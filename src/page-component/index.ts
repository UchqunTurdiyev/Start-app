export { default as AboutPageComponent } from './about-page-componetn/about-page-component';
export { default as ArticleDetailedComponent } from './article-page-component/article-datailed-component';
