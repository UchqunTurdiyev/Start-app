...
import { CourseCreateBodyInterface, DeleteBodyInterface } from './course.interfaces';
...
export const deleteCourse = createAsyncThunk<'Success', DeleteBodyInterface>('course/delete', async (body, thunkApi) => {
	try {
